...
\begin{itemize}
	...
	\item \textbf{TF-IDF con RNA.} Utiliza \gls{tfidf} como entrada de una red neuronal artificial sencilla, concretamente un \gls{perceptron} Multicapa o \gls{mlp}.
\end{itemize}
...
También se aplica \gls{regularizacion_l2}, que en scikit-learn se controla mediante el parámetro \texttt{alpha} y ayuda a mantener la complejidad de la red bajo control~\cite{interactive_chaos_reg}. En conjunto, estas decisiones permiten probar una técnica más flexible que los modelos lineales, pero manteniendo el sistema dentro de unos límites razonables de coste y simplicidad.
