...
\begin{itemize}
	...
	\item Cerrar TFG con un producto funcional demostrable y una memoria técnica sólida, para finalizar el Grado en Ingeniería Informática y poder progresar en mi carrera profesional.
\end{itemize}